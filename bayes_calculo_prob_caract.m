function [product_prob, freq, h] = bayes_calculo_prob_caract(carrinhos, caracteristicas, h)
    ...
    for produto = 1:numel(caracteristicas)
        ...
        waitbar(3/6+2/6*produto/numel(caracteristicas), h, 'A calcular as probabilidades de cada produto...');
    end
